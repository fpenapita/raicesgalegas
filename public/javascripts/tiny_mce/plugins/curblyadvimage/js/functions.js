...
var ImageDialog = {
    ...
    showPreviewImage : function(u, st) {
        ...
        if (!st)
            tinyMCEPopup.dom.setHTML('prev', '<img id="previewImg" src="' + u + '" onload="ImageDialog.updateImageData(this);" onerror="ImageDialog.resetImageData();" />');
        else
            tinyMCEPopup.dom.setHTML('prev', '<img id="previewImg" src="' + u + '" onload="ImageDialog.updateImageData(this, 1);" />');
    }
};
